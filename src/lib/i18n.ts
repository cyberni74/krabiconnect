...
const strings = {
  en: {
    appName: "KrabiConnect",
    tagline: "Krabi’s bilingual marketplace",
    ...
    latest: "Latest",
    howTitle: "How KrabiConnect works",
    how1: "Search",
    ...
    emptyFeed: "New listings show up here. Post in Thai or English — we translate.",
    discover: "Discover",
    search: "Search",
    create: "Post",
    chats: "Messages",
    ...
    signInTitle: "Welcome to KrabiConnect",
    ...
    published: "Published — it’s live on KrabiConnect.",
    ...
    adminOnly: "This area is only for KrabiConnect admins.",
    users: "People",
    ...
    facebookHint: "Paste a Facebook profile or Marketplace seller link. Visitors can contact them there — useful if they have no KrabiConnect account.",
    ...
    agents: "Grok agents",
    agentIntro: "Create a key so a Grok agent can copy Facebook Marketplace ads into KrabiConnect.",
    ...
    agentStep3: "3. The bot reads Facebook Marketplace and posts each ad to KrabiConnect.",
    ...
    agentRule3: "Leave text as-is — KrabiConnect translates Thai and English.",
  ...
  th: {
    ...
    latest: "ล่าสุด",
    howTitle: "KrabiConnect ใช้ยังไง",
    how1: "ค้นหา",
    ...
    emptyFeed: "ประกาศใหม่จะแสดงที่นี่ โพสต์ไทยหรืออังกฤษ — เราแปลให้",
    discover: "ค้นพบ",
    search: "ค้นหา",
    create: "ลงประกาศ",
    chats: "ข้อความ",
    ...
    signIn: "เข้าสู่ระบบ",
    signUp: "สร้างบัญชี",
    signInTitle: "ยินดีต้อนรับสู่ KrabiConnect",
    ...
    published: "เผยแพร่แล้ว แสดงบน KrabiConnect",
    ...
    adminOnly: "ส่วนนี้สำหรับผู้ดูแล KrabiConnect เท่านั้น",
    users: "สมาชิก",
    ...
    facebookHint: "วางลิงก์โปรไฟล์ Facebook หรือผู้ขาย Marketplace ผู้เยี่ยมชมติดต่อได้ที่นั่น — เหมาะถ้ายังไม่มีบัญชี KrabiConnect",
    openFacebook: "ติดต่อทาง Facebook",
    facebookConnected: "เชื่อมโปรไฟล์ Facebook แล้ว",
    facebookLoading: "กำลังดึงโปรไฟล์ Facebook…",
    agents: "เอเจนต์ Grok",
    agentIntro: "สร้างคีย์ให้เอเจนต์ Grok คัดลอกประกาศ Facebook Marketplace เข้า KrabiConnect",
    ...
    agentStep3: "3. บอทอ่าน Facebook Marketplace แล้วส่งเข้า KrabiConnect",
    ...
    agentRule3: "ไม่ต้องแปล ข้อความ — KrabiConnect แปลไทย/อังกฤษเอง",
