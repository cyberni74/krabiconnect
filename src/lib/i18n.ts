 ...
 * title_th / title_en as stored — it does not hide an EN field that contains Thai
 * place names.
 */
...
/**
 * Listing + chrome helper: locale=th always shows the Thai original field;
 * locale=en shows titleEn/descriptionEn when present and non-empty, otherwise
 * falls back to Thai. Does not invent copy or overwrite Thai in the DB.
 */
