...
(cover = images[0]). Re-POST the same sourceUrl/id with titleEn/descriptionEn to seed
the English overlay only — title_th / description_th stay Thai.
PATCH /api/agent/listings/:id with { "images": ["https://…"] } replaces photos.
PATCH { "titleEn", "descriptionEn" } (no images required) seeds English overlay.
